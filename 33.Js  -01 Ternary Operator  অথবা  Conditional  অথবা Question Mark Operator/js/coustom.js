...
let old;
let fastOld = prompt("Iput your age");

old = fastOld <= "30" ? "Admin" : "Modarator";

alert(old);

// এখানে লেসদ্যান ইকুয়াল (<= "30") ব্যবহার করায় যখন কোন ব্যক্তি input Box এর ভিতরে 30 এর নিচের কোন নাম্বার দেবে তখনর Admin দেখাবে। যখন 30 এর উপরে অর্থাৎ 31 থেকে যে নাম্বারই দিক না কেন তখন Modarator বলে গন্য হবে ।
...
let age;
let carrentAge = prompt("Age");
age = carrentAge >= "18" ? "Valid" : "Invalid";
alert(age);

// এখানে গেটারদ্যান ইকুয়ার ( >= "18" ) ব্যবহার করায় 18 বছরের নিচেই হলে Invalid দেখাবে। আর যখন 18 বছরের উপরে দেখাবে তখন Valid দেখাবে ।

/*======================================================================
20 মিনিট Ternary Operator (?:) এর মধ্যে variable এর নাম store করার নিয়ম 
======================================================================*/

let userName02;
let userName03 = prompt("Enter your name");
let fastName = "Selim";
let lastName = "Reza";

userName02 = userName03 == "Selim" ? fastName : lastName;
alert(userName02);

// এখানে Ternary Operator (?:) এর ভিতরে Variable ও বসানো যায় । তাই এখানে Ternary Operator (?:) এর ভিতরে Variable বসানো হয়েছে। এখানে Admin হলো "Selim" বাকী যাই input দেওয়া হোক না কেন সবই "Reza" দেখাবে ।
